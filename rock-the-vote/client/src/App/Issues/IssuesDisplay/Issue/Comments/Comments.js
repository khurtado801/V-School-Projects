        ...
        return (
            <div>
                ...
                <form className="comment-form"onSubmit={this.submitComment}>
                    <textarea className="comment-box"onChange={this.handleChange} type="text" value={this.state.comment} placeholder="Comments" />
                    <button className="post-comment">Submit</button>
                </form>
